...
- **Album cover flip:** 250ms 3D flip to `IMG_5541.png` at 3× cover size; while the photo is visible, the player stacks above it so the play button stays on top and clickable.
